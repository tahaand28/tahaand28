...
من یک توسعه‌دهنده وب با تجربه در توسعه frontend و backend هستم. من اهل ایران هستم. مهارت‌های اصلی من شامل جاوا اسکریپت، html، css و کار با پایگاه‌های داده MySQL است. من به دنبال فرصت‌هایی برای نوآوری و همکاری در تیم‌های پویا هستم.
